...
while True:
	...
	cv2.putText(frame, 'c', (90,200), cv2.FONT_HERSHEY_COMPLEX, 1, (0,0,255), 3, cv2.LINE_AA)

	cv2.rectangle(frame, (152,240), (248, 460), (139,0,0),-1)
	cv2.putText(frame, 'd', (190,200), cv2.FONT_HERSHEY_COMPLEX, 1, (0,0,255), 3, cv2.LINE_AA)

	cv2.rectangle(frame, (252,230), (348, 470), (235,206,135),-1)
	cv2.putText(frame, 'e', (290,200), cv2.FONT_HERSHEY_COMPLEX, 1, (0,0,255), 3, cv2.LINE_AA)

	cv2.rectangle(frame, (352,220), (448, 480), (0,100,0),-1)
	cv2.putText(frame, 'f', (390,200), cv2.FONT_HERSHEY_COMPLEX, 1, (0,0,255), 3, cv2.LINE_AA)

	cv2.rectangle(frame, (452,210), (548, 490), (144,238,144),-1)
	cv2.putText(frame, 'g', (490,200), cv2.FONT_HERSHEY_COMPLEX, 1, (0,0,255), 3, cv2.LINE_AA)

	cv2.rectangle(frame, (552,200), (648, 500), (0,255,255),-1)
	cv2.putText(frame, 'A', (590,200), cv2.FONT_HERSHEY_COMPLEX, 1, (0,0,255), 3, cv2.LINE_AA)

	cv2.rectangle(frame, (652,190), (748,510), (0,165,255),-1)
	cv2.putText(frame, 'B', (690,200), cv2.FONT_HERSHEY_COMPLEX, 1, (0,0,255), 3, cv2.LINE_AA)

	cv2.rectangle(frame, (752,180), (848,520), (59,70,227),-1)
	cv2.putText(frame, 'C', (790,200), cv2.FONT_HERSHEY_COMPLEX, 1, (0,0,255), 3, cv2.LINE_AA)
